...
<html>
<head>
    <title>Telegraph Ave - Because the Internet</title>
...
<body>    
    <h1 id="title">"Telegraph Ave. ("Oakland by Llyod")"</h1>
...
<div id="total">
    ...
    <div id="content" class="wrapper">
        ...
        <iframe width="600" height="400" src="https://www.youtube.com/embed/p3f-eDzkxcw?autoplay=0"></iframe>
        
        <br><br>
        <audio controls>
            <source src="album/TelegraphAve.mp3" type="audio/mpeg">
            Your browser does not support the audio element.
        </audio>
        <br><br>
        <form>
            <input type="button" value="Get Lyrics" onclick="getLyrics('telegraph')">
        </form>
