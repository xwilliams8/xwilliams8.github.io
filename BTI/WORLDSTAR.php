...
<html>
<head>
    <title>WORLDSTAR - Because the Internet</title>
...
<div id="total">
    ...
    <div id="content" class="wrapper">
        ...
        <a href="http://www.worldstarhiphop.com/videos/">
        <img src="worldstarhiphop.png" alt="World Star" id="cover">
        </a>
        <br><br>
        <p>Gambino wrote this song in reference to the sometimes raunchy content of worldstarhiphop.com. Click the picture!!! </p>
        
        <br><br>
        <audio controls>
            <source src="album/WORLDSTAR.mp3" type="audio/mpeg">
            Your browser does not support the audio element.
        </audio>
        
        <br><br>
        <form>
            <input type="button" value="Get Lyrics" onclick="getLyrics('WORLDSTAR')">
        </form>
        <br><br>
        <div id="lyricbox"></div>
