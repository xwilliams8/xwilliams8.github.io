...
<html>
<head>
    <title>No Exit - Because the Internet</title>
...
<body>    
    ...
    <div id="content" class="wrapper">
        ...
        <h2>Play the Song</h2>
        <audio controls>
            <source src="album/NoExit.mp3" type="audio/mpeg">
            Your browser does not support the audio element.
        </audio>
        <br><br>
        <img src="recluse.png" alt="Brown Recluse" id="cover">
        <br><br>
        <form>
            <input type="button" value="Get Lyrics" onclick="getLyrics('noexit')">
        </form>
    <br>
    <br>
        <div id="lyricbox"></div>
