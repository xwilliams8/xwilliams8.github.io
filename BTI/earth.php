...
<html>
<head>
    <title>Earth: the Oldest Computer (The Last Night) - Because the Internet</title>
...
<body>    
    <h1 id="title">"Earth: the Oldest Computer (The Last Night) ft. Macklemore"</h1>
    ...
    <div id="content" class="wrapper">
        ...
        <img src="earth.gif" alt="Earth" id="cover">
    <br>
        <h2>Play</h2>
        <audio controls>
            <source src="album/Earth.mp3" type="audio/mpeg">
            Your browser does not support the audio element.
        </audio>
        <br><br>
        <form>
            <input type="button" value="Get Lyrics" onclick="getLyrics('earth')">
        </form>
        <br>
        <br>
        <div id="lyricbox"></div>
