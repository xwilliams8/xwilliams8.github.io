...
<html>
<head>
    <title>The Library(Intro)/Crawl - Because the Internet</title>
...
<body>    
    <h1 id="title">"The Library(Intro)" - "Crawl"</h1>
...
<div id="total">
    ...
    <img src="library.jpg" alt="Library" id="cover">
        <br><h2>Play: The Library (Intro)</h2><br>
        <audio controls>
            <source src="album/TheLibrary(Intro).mp3" type="audio/mpeg">
            Your browser does not support the audio element.
        </audio>
        
        <br><h2>Play: Crawl</h2><br>
        <audio controls>
            <source src="album/Crawl.mp3" type="audio/mpeg">
            Your browser does not support the audio element.
        </audio>
        
        <br><br>
        <form>
            <input type="button" value="Get Lyrics" onclick="getLyrics('crawl')">
        </form>
        <br>
        <br>
