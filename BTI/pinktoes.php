...
<html>
<head>
    <title>Pink Toes - Because the Internet</title>
...
<body>    
    <h1 id="title">"Pink Toes ft. Jhene Aiko"</h1>
    ...
    <div id="content" class="wrapper">
        ...
        <img src="toes.jpg" alt="Pink Toes" id="cover">
        
        <h2>Play</h2>
        <audio controls>
            <source src="album/PinkToes.mp3" type="audio/mpeg">
            Your browser does not support the audio element.
        </audio>
        <br><br>
        <form>
            <input type="button" value="Get Lyrics" onclick="getLyrics('pinktoes')">
        </form>
        <br><br>
