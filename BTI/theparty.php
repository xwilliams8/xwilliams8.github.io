...
<html>
<head>
    <title>The Party - Because the Internet</title>
...
<body>    
    <h1 id="title">"Playing Around Before the Party Starts" - "The Party"</h1>
...
<div id="total">
    ...
    <div id="content" class="wrapper">
        ...
        <h2>Playing Around Before</h2>
        
        <img src="playing.jpg" alt="Playing Around" id="cover">
        <br><br>
        <audio controls>
            <source src="album/PlayingAroundBeforeThePartyStarts.mp3" type="audio/mpeg">
            Your browser does not support the audio element.
        </audio>
        
        <h2>The Actual Party!!!!!!</h2>
        <audio controls>
            <source src="album/TheParty.mp3" type="audio/mpeg">
            Your browser does not support the audio element.
        </audio>
        <br>
        <img src="gtfo.png" alt="GTFO" id="cover">
        <br><br>
        <form>
            <input type="button" value="Get Lyrics" onclick="getLyrics('party')">
        </form>
    <br>
    <br>
            <div id="lyricbox"></div>
