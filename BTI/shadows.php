...
<html>
<head>
    <title>Shadows - Because the Internet</title>
...
<div id="total">    
    ...
    <div id="content" class="wrapper">
        ...
        <h2>Live on the Arsenio Hall Show!!</h2>
        
        <iframe width="600" height="400" src="https://www.youtube.com/embed/VRfJOrUxWWI"></iframe>
        
        <br><br>
    
        <audio controls>
            <source src="album/Shadows.mp3" type="audio/mpeg">
            Your browser does not support the audio element.
        </audio>
        
        <br><br>
        <form>
            <input type="button" value="Get Lyrics" onclick="getLyrics('shadows')">
        </form>
    <br>
    <br>
        <div id="lyricbox"></div>
