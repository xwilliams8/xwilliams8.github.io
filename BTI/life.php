...
<html>
<head>
    <title>Life: the Biggest Troll (Andrew Auernheimer) - Because the Internet</title>
...
<body>    
    <h1 id="title">"Life: the Biggest Troll (Andrew Auernheimer)"</h1>
    ...
    <div id="content" class="wrapper">
        ...
        <h2>"Leaked" Version</h2>
        <audio controls>
            <source src="album/Life.mp3" type="audio/mpeg">
            Your browser does not support the audio element.
        </audio>
        <br>
        <br>
        <img src="maybe.png" alt="HE ADMITTED TO LEAKING HIS OWN ALBUM!!!!!" id="cover">
        <br>
        <br>
        <h2>Full Version</h2>
        <audio controls>
            <source src="album/lifefull.mp3" type="audio/mpeg">
            Your browser does not support the audio element.
        </audio>
        <br><br>
        <form>
            <input type="button" value="Get Lyrics" onclick="getLyrics('life')">
        </form>
        <br>
        <br>
        <div id="lyricbox"></div>
