...
<html>
<head>
    <title>Dial Up/The Worst Guys - Because the Internet</title>
...
<body>    
    <h1 id="title">"Dial up" - "The Worst Guys" ft. Chance the Rapper</h1>
...
<div id="total">
    ...
    <div id="content" class="wrapper">
        ...
        <h2>Play Dial Up</h2>
         ...
         <br><br>
        <audio controls>
            <source src="album/DialUp.mp3" type="audio/mpeg">
            Your browser does not support the audio element.
        </audio>
    
        <h2>Official Video</h2>
        
        <iframe width="600" height="400" src="https://www.youtube.com/embed/dwUug-ucBLc?autoplay=0"></iframe>
        ...
        <br><br>
         ...
         <br><br>
        <audio controls>
            <source src="album/TheWorstGuys.mp3" type="audio/mpeg">
            Your browser does not support the audio element.
        </audio>
        <br><br>
        <form>
            <input type="button" value="Get Lyrics" onclick="getLyrics('worstguys')">
        </form>
