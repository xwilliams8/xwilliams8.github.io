...
<html>
<head>
    <title>Zealots of Stockholm (Free Information) - Because the Internet</title>
...
<body>    
    <h1 id="title">"Zealots of Stockholm (Free Information)"</h1>
    ...
    <div id="content" class="wrapper">
        ...
        <h2>Play</h2>
        <audio controls>
            <source src="album/ZealotsOfStockholm.mp3" type="audio/mpeg">
            Your browser does not support the audio element.
        </audio>
        <br><br>
            <iframe width="600" height="400" src="https://www.youtube.com/embed/zcOInW2b2DI"></iframe>
        <br><br>
        <form>
            <input type="button" value="Get Lyrics" onclick="getLyrics('zealots')">
        </form>
        <br>
        <br>
        <div id="lyricbox"></div>
