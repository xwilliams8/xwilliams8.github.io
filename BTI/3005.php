...
<html>
<head>
    <title>3005 - Because the Internet</title>
...
<div id="total">
    ...
    <div id="content" class="wrapper">
        ...
        <iframe width="600" height="400" src="https://www.youtube.com/embed/tG35R8F2j8k?autoplay=0"></iframe>
        
        <br><br>
        <audio controls>
            <source src="album/3005.mp3" type="audio/mpeg">
            Your browser does not support the audio element.
        </audio>
        <br><br>
        <form>
            <input type="button" value="Get Lyrics" onclick="getLyrics('3005')">
        </form>
        <br><br>
