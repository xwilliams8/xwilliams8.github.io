...
<html>
<head>
    <title>Death by Numbers/Flight of the Navigator - Because the Internet</title>
...
<body>    
    <h1 id="title">"Death by Numbers" - "Flight of the Navigator"</h1>
    <div id="total">
    ...
    <div id="content" class="wrapper">
        ...
        <h2>Death By Numbers</h2>
        
        <iframe width="600" height="400" src="https://www.youtube.com/embed/nBV1PPD_Emw"></iframe>
        
        <br><br>
        <audio controls>
            <source src="album/DeathByNumbers.mp3" type="audio/mpeg">
            Your browser does not support the audio element.
        </audio>
        <br><br>
        <h2>Play: Flight of the Navigator</h2>
        <audio controls>
            <source src="album/FlightOfTheNavigator.mp3" type="audio/mpeg">
            Your browser does not support the audio element.
        </audio>
        <br><br>
        <form>
            <input type="button" value="Get Lyrics" onclick="getLyrics('navigator')">
        </form>
    <br>
    <br>
        <div id="lyricbox"></div>
